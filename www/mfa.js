...
class MFA {
    init(){
        channel.onCordovaReady.subscribe(this.subscribe);
    }
                        ...
                        ref.executeScript(
                            ...
                            function (values) {
                                ...
                                if (errorText !== '' && errorText != null) {
                                    ...
                                    if (typeof errorCallback == 'function') { errorCallback(errorText); }
    ...
    loadErrorHandler(params, ref) {
        ...
        if (typeof errorCallback == 'function') { errorCallback(params.message); }
    }
}
MFA.init();
